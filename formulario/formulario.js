function valida() {
  ...
  if (nombre == "") {
    ...
    if (specials(nombre) == 1) {
      ...
      errores.push("Campo nombre con caracteres no válidos");
    } else {
      enombre.innerHTML = "";
    }
  }
  ...
  if (pais != 0) {
    if (!paises.includes(pais)) {
      ...
      errores.push("Opción de país seleccionada no válida");
    } else {
      epais.innerHTML = "";
    }
  }
  ...
  if (genero != 0) {
    if (!generos.includes(genero)) {
      ...
      errores.push("Opción de genero seleccionada no válida");
    } else {
      egenero.innerHTML = "";
    }
  }
  ...
  if (correo == "") {
    ...
    if (!filtro_correo.test(correo)) {
      ...
      errores.push("Campo correo con caracteres no válidos");
    } else {
      ecorreo.innerHTML = "";
    }
  }
  ...
  if (pwd == "") {
    ...
    if (!filtro_pwd.test(pwd)) {
      ...
      errores.push("Campo contraseña con caracteres no válidos");
    } else {
      epwd.innerHTML = "";
    }
  }
  ...
  if (!terminos.checked) {
    ...
    errores.push("Campo terminos obligatorio");
  } else {
    eterminos.innerHTML = "";
  }
